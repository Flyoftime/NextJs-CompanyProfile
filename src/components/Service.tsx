...
const Service = () => {
    return (
        <div className="bg-[#ffff]">
            ...
            <div className='m-o flex flex-wrap justify-center items-center bg-[#1111] p-8'>
                <div className='w-full md:w-1/2 lg:w-auto lg:mr-4 mb-4 md:mb-0'>
                    <div className='w-full h-auto relative mx-auto bg-white rounded-2xl overflow-hidden'>
                        ...
                        <img className='rounded-2xl opacity-100 h-full hover:opacity-0' src='/assets/bg.jpg' alt="service"></img>
                    </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-auto lg:mr-4 mb-4 md:mb-0'>
                    <div className='crd rounded-2xl'>
                        ...
                        <img className='image' src='/assets/bg.jpg' alt="service"></img>
                    </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-auto lg:mr-4 mb-4 md:mb-0'>
                    <div className='crd rounded-2xl'>
